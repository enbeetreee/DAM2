package ex2Hibernate.entity;
// Generated 29 oct 2024, 8:15:56 by Hibernate Tools 4.3.6.Final
 ...
 */
@Entity
@Table(name = "autores", catalog = "biblio2")
public class Autores implements java.io.Serializable {
	...
	@JoinTable(name = "escribir", catalog = "biblio2", joinColumns = {
